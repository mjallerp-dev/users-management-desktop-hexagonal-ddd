...
@Getter
public class EnterpriseCreatedDomainEvent extends DomainEvent {

    private static final String EVENT_NAME = "enterprise.created";

    private final EnterpriseModel enterprise;

    public EnterpriseCreatedDomainEvent(final EnterpriseModel enterprise) {
        super(EVENT_NAME);
